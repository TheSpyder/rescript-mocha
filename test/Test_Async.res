// open Mocha
// open Mocha.DoneCallback

// describe("Async", () => {
//   /* Calls given function after a small delay */
//   let delay = fn => ignore(Js.Global.setTimeout(() => fn(), 300))
...
//       "should time out",
//       ~timeout=50,
//       done_ => ignore(Js.Global.setTimeout(() => done_(), 51)),
//     )

//     it("should not time out", ~timeout=50, done_ => ignore(Js.Global.setTimeout(() => done_(), 40)))
//   })
...
//       ~slow=50,
//       done_ => ignore(Js.Global.setTimeout(() => done_(), 40)),
//     )
//   )
// })
